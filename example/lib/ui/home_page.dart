...
final example02 = ExamplePage(viewModel: viewModel02);
...
final example03 = ExamplePage(viewModel: viewModel03);
...
final example04 = ExamplePage(viewModel: viewModel04);
...
final example05 = ExamplePage(viewModel: viewModel05);

/// Example 06
final customWidth06 = CustomSliderWidths(
  trackWidth: 4,
  progressBarWidth: 40,
  shadowWidth: 70,
);
final customColors06 = CustomSliderColors(
  dotColor: Colors.white.withAlpha((0.1 * 255).toInt()),
  trackColor: HexColor('#F9EBE0').withAlpha((0.2 * 255).toInt()),
  progressBarColors: [
    HexColor('#A586EE').withAlpha((0.3 * 255).toInt()),
    HexColor('#F9D3D2').withAlpha((0.3 * 255).toInt()),
    HexColor('#BF79C2').withAlpha((0.3 * 255).toInt()),
  ],
          ...
          decoration: BoxDecoration(
            gradient: LinearGradient(
              colors: [
                Color.fromARGB(
                  (value / 360 * 255).toInt(),
                  (HexColor('#F9D3D2').r * 255.0).round() & 0xff,
                  (HexColor('#F9D3D2').g * 255.0).round() & 0xff,
                  (HexColor('#F9D3D2').b * 255.0).round() & 0xff,
                ),
                Color.fromARGB(
                  (value / 360 * 255).toInt(),
                  (HexColor('#BF79C2').r * 255.0).round() & 0xff,
                  (HexColor('#BF79C2').g * 255.0).round() & 0xff,
                  (HexColor('#BF79C2').b * 255.0).round() & 0xff,
                ),
              ],
...
final example06 = ExamplePage(viewModel: viewModel06);

/// Example 07
final customWidth07 = CustomSliderWidths(
  trackWidth: 2,
  progressBarWidth: 10,
  shadowWidth: 20,
);
final customColors07 = CustomSliderColors(
  dotColor: Colors.white.withAlpha((0.1 * 255).toInt()),
  trackColor: HexColor('#7EFFFF').withAlpha((0.2 * 255).toInt()),
  progressBarColors: [
    HexColor('#17C5E5'),
    HexColor('#DFFF97'),
    HexColor('#04FFB5'),
...
final example07 = ExamplePage(viewModel: viewModel07);

/// Example 08
final customWidth08 = CustomSliderWidths(
  trackWidth: 1,
  progressBarWidth: 15,
  shadowWidth: 50,
);
final customColors08 = CustomSliderColors(
  ...
  trackColor: HexColor('#7EFFFF').withAlpha((0.1 * 255).toInt()),
  progressBarColors: [
    HexColor('#3586FC').withAlpha((0.1 * 255).toInt()),
    HexColor('#FF8876').withAlpha((0.25 * 255).toInt()),
    HexColor('#FAFF76').withAlpha((0.5 * 255).toInt()),
  ],
...
final example08 = ExamplePage(viewModel: viewModel08);

/// Example 09
final customWidth09 = CustomSliderWidths(
  trackWidth: 1,
  progressBarWidth: 15,
  shadowWidth: 50,
);
final customColors09 = CustomSliderColors(
  dotColor: Colors.white.withAlpha((0.5 * 255).toInt()),
  trackColor: HexColor('#000000').withAlpha((0.1 * 255).toInt()),
  progressBarColors: [
    HexColor('#3586FC').withAlpha((0.1 * 255).toInt()),
    HexColor('#FF8876').withAlpha((0.25 * 255).toInt()),
    HexColor('#3586FC').withAlpha((0.5 * 255).toInt()),
  ],
  shadowColor: HexColor('#133657'),
  shadowMaxOpacity: 0.02,
);
...
final example09 = ExamplePage(viewModel: viewModel09);

/// Example 09
final customWidth10 = CustomSliderWidths(
  trackWidth: 1,
  progressBarWidth: 28,
  shadowWidth: 60,
);
final customColors10 = CustomSliderColors(
  ...
  trackColor: HexColor('#000000').withAlpha((0.1 * 255).toInt()),
  progressBarColors: [
    HexColor('#76E2FF').withAlpha((0.5 * 255).toInt()),
    HexColor('#4E09ED').withAlpha((0.5 * 255).toInt()),
    HexColor('#F7E4FF').withAlpha((0.3 * 255).toInt()),
  ],
  dynamicGradient: true,
...
final example10 = ExamplePage(viewModel: viewModel10);
